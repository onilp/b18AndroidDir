package com.calvert.mapactivity;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng rjt = new LatLng(41.9194, -88.3070);
        float zoom = 5;
        mMap.addMarker(new MarkerOptions().position(rjt).title("Marker in RJT"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(rjt, zoom));
